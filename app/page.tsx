    ...
    <main className="flex flex-1 flex-col py-12">
      ...
      <section className="relative mt-10 mb-10 flex-1 w-full min-h-[320px]">
        <p className="max-w-4xl text-left text-lg leading-relaxed">
          Auspidiam is the creative force whose roots span <a href="https://en.wikipedia.org/wiki/Himalayas">mountains</a> and sprouts <a href="https://plato.stanford.edu/entries/determinism-causal/">will</a> the air.
        </p>
      </section>
    </main>
  );
